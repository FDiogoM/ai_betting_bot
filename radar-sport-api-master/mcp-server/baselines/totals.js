...
function totalsBaseline(homeProfile, awayProfile, lines, options = {}) {
  ...
  const homeForAtHome = venueMean(homeProfile.matches, 'home', forOf, 'home team', caveats);
  const homeAgainstAtHome = venueMean(homeProfile.matches, 'home', againstOf, 'home team', caveats);
  const awayForAway = venueMean(awayProfile.matches, 'away', forOf, 'away team', caveats);
  const awayAgainstAway = venueMean(awayProfile.matches, 'away', againstOf, 'away team', caveats);
